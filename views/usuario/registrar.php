...
<div class="container-fluid">
	...
	<div class="container-login" >
			...
			<span class="login100-form-title p-b-53  ">
                        <div class="row">
                            <div class="col-12 text-center" id="amarillo">
                                <img src="<?=base_url?>assets/img/avatars.png" width="30%">
                            </div>
                            
                            <div class="col-12 " id="verde">
                               <h3>BIENVENIDO RUNNER</h3>
                                <h5>Regístrate y participá de nuestro sorteos</h5> 
                            </div>
			...
			<div class="p-t-31 p-b-9">
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100 form-control" type="text" pattern="[0-9]{8}" name="dni" placeholder="TU DNI SIN PUNTOS (8 DIGITOS)" >
