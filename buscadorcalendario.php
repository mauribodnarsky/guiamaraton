...
if ($_GET['texto'] == "" && $_GET['categoria']=="" && $_GET['lugar']=="" && $_GET['mes']!=""){
  ...
  $eventos= $objetoevento->buscareventocalendario("","","",$_GET['mes']);
}
if ($_GET['texto'] == "" && $_GET['categoria']!="" && $_GET['lugar']!="" && $_GET['mes']!=""){
  $busca= explode(' ', $_GET['texto']);
  $buscar="";
  ...
  $eventos= $objetoevento->buscareventocalendario("",$_GET['categoria'],$_GET['lugar'],$_GET['mes']);
}
if ($_GET['texto'] == "" && $_GET['categoria']=="" && $_GET['lugar']!="" && $_GET['mes']!=""){
  $busca= explode(' ', $_GET['texto']);
  $buscar="";
  ...
  $eventos= $objetoevento->buscareventocalendario("","",$_GET['lugar'],$_GET['mes']);
}
...
if ($_GET['texto'] != "" && $_GET['categoria']=="" && $_GET['lugar']=="" && $_GET['mes']==""){
  ...
  $eventos= $objetoevento->buscareventocalendario($_GET['texto']."%","","","");
}
if ($_GET['texto'] != "" && $_GET['categoria']!="" && $_GET['lugar']!="" && $_GET['mes']==""){
  $busca= explode(' ', $_GET['texto']);
  $buscar="";
  ...
  $eventos= $objetoevento->buscareventocalendario($_GET['texto'],$_GET['categoria'],"","");
}
if ($_GET['texto'] == "" && $_GET['categoria']!="" && $_GET['lugar']!="" && $_GET['mes']==""){
  $busca= explode(' ', $_GET['texto']);
  $buscar="";
  ...
  $eventos= $objetoevento->buscareventocalendario("",$_GET['categoria'],$_GET['lugar'],"");
}
if ($_GET['texto'] == "" && $_GET['categoria']!="" && $_GET['lugar']=="" && $_GET['mes']==""){
  $busca= explode(' ', $_GET['texto']);
  $buscar="";
  ...
  $eventos= $objetoevento->buscareventocalendario("",$_GET['categoria'],"","");
}
...
if ($_GET['texto'] == "" && $_GET['categoria']=="" && $_GET['lugar']=="" && $_GET['mes']==""){
  ...
  $eventos= $objetoevento->buscareventocalendario("","","","");
}
if ($_GET['texto'] == "" && $_GET['categoria']=="" && $_GET['lugar']!="" && $_GET['mes']==""){
  $busca= explode(' ', $_GET['texto']);
  $buscar="";
  ...
  $eventos= $objetoevento->buscareventocalendario("","",$_GET['lugar'],"");
}
          ...
          if ($_GET['texto'] == "" && $_GET['categoria']!="" && $_GET['lugar']=="" && $_GET['mes']!=""){
            ...
            $eventos= $objetoevento->buscareventocalendario("",$_GET['categoria'],"",$_GET['mes']);
          }
          ...
          if ($_GET['texto'] == "" && $_GET['categoria']!="" && $_GET['lugar']!="" && $_GET['mes']!=""){
            ...
            $eventos= $objetoevento->buscareventocalendario("",$_GET['categoria'],$_GET['categoria'],$_GET['mes']);
          }
          ...
          if ($_GET['texto'] != "" && $_GET['categoria']=="" && $_GET['lugar']!="" && $_GET['mes']==""){
            ...
            $eventos= $objetoevento->buscareventocalendario($_GET['texto'],"",$_GET['lugar'],"");
          }
          ...
          if ($_GET['texto'] != "" && $_GET['categoria']!="" && $_GET['lugar']!="" && $_GET['mes']==""){
            ...
            $eventos= $objetoevento->buscareventocalendario($_GET['texto'],$_GET['categoria'],$_GET['lugar'],"");
          }
